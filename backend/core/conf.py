...
class Settings(BaseSettings):
    ...
    # .env Token
    TOKEN_SECRET_KEY: str  # Secret key, generated by secrets.token_urlsafe(32)
    # FastAPI
    ...
    CAPTCHA_LOGIN_EXPIRE_SECONDS: int = 60 * 5  # Expiration time, in seconds
...
@lru_cache
def get_settings():
    """Optimized way to read configuration"""
    return Settings()
