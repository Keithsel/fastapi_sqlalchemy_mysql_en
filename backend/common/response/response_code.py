...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_201 = (201, 'Resource created successfully')
    ...
    HTTP_425 = (425, 'Cannot process request, server cannot meet requirements')
    HTTP_429 = (429, 'Too many requests, server limit reached')
    HTTP_500 = (500, 'Internal server error')
    HTTP_502 = (502, 'Bad gateway')
    HTTP_503 = (503, 'Server temporarily unavailable')
...
class CustomResponse:
    """
    Provides open response status codes instead of enums, useful if you want to customize response messages
    """
